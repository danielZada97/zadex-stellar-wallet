...
const ExchangeRateChart = () => {
  ...
  useEffect(() => {
    const fetchHistoricalData = async () => {
      ...
      try {
        const historicalRates = await exchangeRatesService.getHistoricalRates(selectedCurrency, 30);
      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          <CardTitle className="text-white flex items-center">
            ...
            Exchange Rate Chart
            {isLoading && <span className="text-cyan-400 text-sm ml-2">(Loading...)</span>}
          </CardTitle>
