    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-cyan-300 text-xl mb-4 animate-fade-in">
            Loading Zadex Interface...
          </div>
    ...
    >
      ...
      <section className="relative px-6 py-20">
        <div className="max-w-7xl mx-auto text-center">
          <div className="relative mb-8">
            <h1
              className={`text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-fade-in`}
            >
              Your Futuristic
              <br />
              Digital Wallet
          ...
          >
            ...
            real-time currency exchange, advanced security, and intuitive
            design.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/register">
              <Button
                size="lg"
                className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white px-8 py-4 text-lg group"
              >
                Launch Zadex
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Live currency conversion with up-to-the-second exchange rates and market data.",
              },
              {
                icon: Users,
                title: "Instant Transfers",
                description:
                  "Send money to anyone, anywhere, instantly with minimal fees and maximum speed.",
              },
              {
                icon: Zap,
                title: "Smart Alerts",
                description:
                  "AI-powered notifications for rate changes, transactions, and market opportunities.",
              },
            ].map((feature, index) => (
              <Card
                key={index}
                  ...
                  <div className="relative mb-4 inline-block">
                    ...
                    <div
                      className={`absolute -inset-2 ${
                        isDark ? "bg-cyan-400/20" : "bg-purple-600/20"
                      } rounded-full blur opacity-0 group-hover:opacity-100 transition-opacity`}
                    ></div>
                  </div>
                  <h3
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative">
            <Card
              className={`${
                isDark
                  ? "bg-gradient-to-r from-slate-800/50 to-purple-800/50 border-slate-700"
                  : "bg-gradient-to-r from-white/50 to-purple-100/50 border-slate-200"
              } backdrop-blur-sm p-12`}
            >
              <CardContent>
                <h2
                ...
                >
                  Join thousands of users who have already upgraded to the next
                  generation of digital finance.
                </p>
                <Link to="/register">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white px-12 py-4 text-lg"
                  >
                    Start Your Journey
                  </Button>
                </Link>
